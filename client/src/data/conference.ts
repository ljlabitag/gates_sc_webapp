...
export const COMPONENTS = [
  {
    ...
    desc: "Discover geospatial use cases and applications co-developed by the GATES Program with DOST attached agencies and development partners to address real-world challenges.",
  },
  {
    color: "orange",
    title: "Geospatial Gallery",
    short: "Maps built from DOST datasets, layered across agencies.",
    desc: "Explore a visual gallery within the conference venue featuring maps and geospatial visualizations generated by layering and analyzing datasets from across the DOST System under the Program.",
  },
  {
    color: "plum",
    title: "GATES GeoHack 2026",
    short: "Six finalist teams build on the GATES Lakehouse, then pitch live at the conference.",
    desc: "Witness the final pitches of geospatial technology ideas and solutions from the finalists of GATES GeoHack 2026: Charting Spatial Futures. A major side activity of the conference, the hackathon challenges DOST System personnel and eligible DOST-SEI scholars to develop innovative geospatial solutions using the GATES Lakehouse, datasets, and tools to address operational challenges and explore new possibilities for geospatial innovation.",
    to: "/hackathon",
...
export const PARTICIPANTS = [
  {
    color: "blue",
    group: "DOST System Personnel",
    detail:
      "Representatives from the DOST Central Office, Attached Agencies, and Regional Offices working with GATES in co-developing geospatial solutions and exploring applications for better planning and decision-making.",
  },
  {
    color: "orange",
    group: "Government Agencies",
    detail: "Representatives from National Government Agencies working with GATES on geospatial and data-driven initiatives.",
  },
  {
    color: "plum",
    group: "Development partners",
    detail:
      "Development organizations collaborating with the GATES Program on data interoperability, governance, and digital transformation capabilities.",
  },
] as const;
